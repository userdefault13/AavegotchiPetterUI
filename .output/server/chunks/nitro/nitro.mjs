...
function safeDestr(value, options = {}) {
  return destr$1(value, { ...options, strict: true });
}
  ...
  return (function(n2, o3) {
    ...
    return n.test(t2) ? "xn--" + (function(n2) {
      ...
      for (h && t3.push("-"); p < o3; ) {
        ...
        const a = p + 1;
        o4 - f > e$1((2147483647 - i) / a) && s$2("overflow"), i += (o4 - f) * a, f = o4;
        for (const o5 of n2) {
          if (o5 < f && ++i > 2147483647 && s$2("overflow"), o5 == f) {
            let n3 = i;
            for (let o6 = 36; ; o6 += 36) {
            ...
            t3.push(r$1(c$1(n3, 0))), l = u(i, a, p == h), i = 0, ++p;
          }
        }
        ++i, ++f;
      }
...
function normalizeURL(input) {
  ...
  parsed.hash = encodeHash(decode$1(parsed.hash));
  parsed.host = encodeHost(decode$1(parsed.host));
...
function parseAuth(input = "") {
  ...
  return {
    ...
    password: decode$1(password)
  };
}
function parseHost(input = "") {
  const [hostname, port] = (input.match(/([^/:]*):?(\d+)?/) || []).splice(1);
  return {
    hostname: decode$1(hostname),
    port
  };
}
...
class $URL {
  ...
  constructor(input = "") {
    ...
    const parsed = parseURL(input);
    this.protocol = decode$1(parsed.protocol);
    this.host = decode$1(parsed.host);
    this.auth = decode$1(parsed.auth);
    this.pathname = decodePath(parsed.pathname);
    this.query = parseQuery(parsed.search);
    this.hash = decode$1(parsed.hash);
  }
  get hostname() {
...
function sendError(event, error, debug) {
  ...
  setResponseStatus$2(event, _code, h3Error.statusMessage);
...
function setResponseStatus$2(event, code, text) {
  if (code) {
...
function toNodeListener(app) {
  const toNodeHandle = async function(req, res) {
    ...
    try {
      ...
      setResponseStatus$2(event, error.statusCode, error.statusMessage);
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2f80e29b-af39-45f2-ad6f-608aaa5cee1c",
...
const dist = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  ...
  serialize: serialize,
  splitSetCookieString: splitSetCookieString
}, Symbol.toStringTag, { value: 'Module' }));
...
const errorHandler$1 = defineNitroErrorHandler(
  function defaultNitroErrorHandler(error, event) {
    ...
    setResponseStatus$2(event, res.status, res.statusText);
...
`, error);
  ...
  setResponseStatus$2(event, statusCode, statusMessage);
...
const assets = {
  "/_nuxt/CaTB3BL6.js": {
    ...
    "etag": "\"6cc3-m5yhNUT7Kp51LCaiO3dCEM/nC/c\"",
    "mtime": "2026-02-21T16:37:36.058Z",
    "size": 27843,
    "path": "../public/_nuxt/CaTB3BL6.js"
  },
  "/_nuxt/Cq24avcm.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2bbbb-ADHnMvgBAFULhSi5HI1dijXA2To\"",
    "mtime": "2026-02-21T16:37:36.059Z",
    "size": 179131,
    "path": "../public/_nuxt/Cq24avcm.js"
  },
  "/_nuxt/Cs5VIxZr.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1105-QjlI5J21FC1FFWs8GnxFvxHZips\"",
    "mtime": "2026-02-21T16:37:36.058Z",
    "size": 4357,
    "path": "../public/_nuxt/Cs5VIxZr.js"
  },
  "/_nuxt/DYSN9uda.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"d3e-/aJN15XKOzxz9ivAQLUDy9p2Wmo\"",
    "mtime": "2026-02-21T16:37:36.058Z",
    "size": 3390,
    "path": "../public/_nuxt/DYSN9uda.js"
  },
  "/_nuxt/DzOpm0mF.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2386-9yIDPyix/bKv5KDeUjZVInO+/I8\"",
    "mtime": "2026-02-21T16:37:36.058Z",
    "size": 9094,
    "path": "../public/_nuxt/DzOpm0mF.js"
  },
  "/_nuxt/QHNtm79a.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"373e6-h7WLNEzhmMZ0KGkPp6GYeDfFcLI\"",
    "mtime": "2026-02-21T16:37:36.060Z",
    "size": 226278,
    "path": "../public/_nuxt/QHNtm79a.js"
  },
  ...
  "/_nuxt/builds/latest.json": {
    ...
    "etag": "\"47-NI9OoiUhAP5Pp7fnqOoqv21fnaQ\"",
    "mtime": "2026-02-21T16:37:36.049Z",
    "size": 71,
    "path": "../public/_nuxt/builds/latest.json"
  },
  "/_nuxt/builds/meta/2f80e29b-af39-45f2-ad6f-608aaa5cee1c.json": {
    "type": "application/json",
    "etag": "\"8b-2nUU4StlUgXfBGiKzTSoFdP2t98\"",
    "mtime": "2026-02-21T16:37:36.036Z",
    "size": 139,
    "path": "../public/_nuxt/builds/meta/2f80e29b-af39-45f2-ad6f-608aaa5cee1c.json"
  }
};
...
const _GrHKKP = eventHandler((event) => {
  ...
  if (ifNotMatch) {
    setResponseStatus$2(event, 304, "Not Modified");
    return "";
  }
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(dist$1);

const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(dist);

const require$$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(dist$2);

const ufo = require$$0;
const cookieEs = require$$1;
const destr = require$$3;

function _interopDefaultCompat$1 (e) { return e && typeof e === 'object' && 'default' in e ? e.default : e; }

const destr__default = /*#__PURE__*/_interopDefaultCompat$1(destr);
...
var defineEventHandler_1 = defineEventHandler;
var deleteCookie_1 = deleteCookie;
var getCookie_1 = getCookie;
var getHeader_1 = getHeader;
var getMethod_1 = getMethod;
var getQuery_1 = getQuery;
var getRouterParam_1 = getRouterParam;
var readBody_1 = readBody;
var setCookie_1 = setCookie;
var setResponseStatus_1 = setResponseStatus;

const _SxA8c9 = defineEventHandler_1(() => {});

const _lazy_pVl8he = () => import('../routes/api/auth/check.get.mjs');
const _lazy_ZvWudR = () => import('../routes/api/auth/logout.post.mjs');
const _lazy_LMDnN5 = () => import('../routes/api/auth/me.get.mjs');
const _lazy_ucSKS7 = () => import('../routes/api/auth/verify.post.mjs');
const _lazy_9LFQow = () => import('../routes/api/bot/config.get.mjs');
const _lazy_tzHLNN = () => import('../routes/api/bot/frequency.get.mjs');
const _lazy_JjSPcC = () => import('../routes/api/bot/frequency.post.mjs');
const _lazy_r9J2XF = () => import('../routes/api/bot/logs.get.mjs');
const _lazy_OrOcxI = () => import('../routes/api/bot/run.post.mjs');
const _lazy_ObhiuS = () => import('../routes/api/bot/start.post.mjs');
const _lazy_ZgUbvc = () => import('../routes/api/bot/status.get.mjs');
const _lazy_lqiQgb = () => import('../routes/api/bot/stop.post.mjs');
const _lazy_r9zscl = () => import('../routes/api/bot/trigger.get.mjs');
const _lazy_U2NEtV = () => import('../routes/api/bot/trigger.post.mjs');
const _lazy_7wM_sm = () => import('../routes/api/delegated-owners.get.mjs');
const _lazy_2O16zh = () => import('../routes/api/delegation/clear-all.post.mjs');
const _lazy_6lH6On = () => import('../routes/api/delegation/owners.get.mjs');
const _lazy_66rZ8b = () => import('../routes/api/delegation/register.post.mjs');
const _lazy_bQA76k = () => import('../routes/api/delegation/registered.get.mjs');
const _lazy_sNPHMm = () => import('../routes/api/delegation/unregister.post.mjs');
const _lazy_KSwdmL = () => import('../routes/api/errors/clear.post.mjs');
const _lazy_3JRcxT = () => import('../routes/api/index.get.mjs');
const _lazy_dTMlQs = () => import('../routes/api/health.get.mjs');
const _lazy_IKyWGN = () => import('../routes/api/petter-balance.get.mjs');
const _lazy_5fu4XE = () => import('../routes/api/stats.get.mjs');
const _lazy_s9pQ73 = () => import('../routes/api/transactions/_hash_.get.mjs');
const _lazy_CYtH6M = () => import('../routes/api/transactions/backfill-gas.post.mjs');
const _lazy_ASjYXG = () => import('../routes/api/transactions/clear.post.mjs');
const _lazy_POYyUs = () => import('../routes/api/index.get2.mjs');
const _lazy_GxqLoo = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });
  ...
  return eventHandler(async (event) => {
    ...
    if (!ctx.response) {
      ...
      if (!ctx.response) {
        ...
        setResponseStatus$2(event, _currentStatus === 200 ? 500 : _currentStatus);
        return send$1(
          event,
...
export { $fetch as $, createHooks as A, executeAsync as B, toRouteMatcher as C, createRouter$1 as D, defu as E, parseQuery as F, withTrailingSlash as G, withoutTrailingSlash as H, nodeServer as I, getHeader_1 as a, getRouterParam_1 as b, createError_1 as c, defineEventHandler_1 as d, deleteCookie_1 as e, setCookie_1 as f, getCookie_1 as g, getMethod_1 as h, getQuery_1 as i, joinRelativeURL as j, getResponseStatusText as k, getResponseStatus as l, defineRenderHandler as m, getQuery$1 as n, createError$1 as o, getRouteRules as p, useNitroApp as q, readBody_1 as r, setResponseStatus_1 as s, hasProtocol as t, useRuntimeConfig as u, isScriptProtocol as v, joinURL as w, withQuery as x, sanitizeStatusCode$1 as y, getContext as z };
